...
<sitefinity:ResourceLinks ID="resourcesLinks" runat="server" UseEmbeddedThemes="True">
    <sitefinity:ResourceFile AssemblyInfo="NewsRotator.Rotator, NewsRotator" Name="NewsRotator.Resources.Stylesheets.default.css"
        Static="true" />
    <sitefinity:ResourceFile AssemblyInfo="NewsRotator.Rotator, NewsRotator" Name="NewsRotator.Resources.Stylesheets.RightViewOverlay.css"
        Static="true" />
...
<sf:RadRotator id="RadRotator1" runat="server" RotatorType="FromCode">
    <ItemTemplate>
        <asp:Panel runat="server" ID="wrapperDiv" class="Box">
            <asp:Panel runat="server" ID="ImageBackgroundPanel" CssClass="Image ImageRightViewOverlay">
                <div class="ArticleBackground ArticleBackgroundRightViewOverlay"></div>
                <div class="Article ArticleRightViewOverlay">
