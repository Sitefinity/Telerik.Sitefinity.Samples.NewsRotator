...
<sitefinity:ResourceLinks ID="resourcesLinks" runat="server" UseEmbeddedThemes="True">
    <sitefinity:ResourceFile AssemblyInfo="NewsRotator.Rotator, NewsRotator" Name="NewsRotator.Resources.Stylesheets.default.css"
        Static="true" />
    <sitefinity:ResourceFile AssemblyInfo="NewsRotator.Rotator, NewsRotator" Name="NewsRotator.Resources.Stylesheets.WideViewOverlay.css"
        Static="true" />
...
<sf:RadRotator id="RadRotator1" runat="server" RotatorType="FromCode">
    <ItemTemplate>
        <asp:Panel runat="server" ID="wrapperDiv" CssClass="Box">
            <asp:Panel runat="server" ID="ImageBackgroundPanel" CssClass="Image ImageWideViewOverlay">
                <div class="ArticleBackground ArticleBackgroundWideViewOverlay"></div>
                <div class="Article ArticleWideViewOverlay">
